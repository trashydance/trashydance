	...
	return (
		<>
			...
			<div className="mt-20 mb-8 sm:mb-12 text-center md:text-left pr-4">
				<h1 className="font-black text-4xl sm:text-6xl uppercase tracking-widest text-black">Settings</h1>
				<p className="font-bold text-xl sm:text-3xl mt-2 text-black/60 uppercase">Configure your cloud</p>
			</div>

			<div className="flex flex-col gap-6">
				<div className="bg-white border-4 border-black rounded-3xl p-6 sm:p-8 shadow-[8px_8px_0_0_rgba(0,0,0,1)]">
					<h2 className="font-black text-2xl uppercase mb-4 text-black">Room Options</h2>
					<p className="font-bold text-lg text-black/70">WIP: No settings available yet.</p>
				</div>
			</div>
		</>
	);
