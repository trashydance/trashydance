	...
	return (
		<div className={cn("flex flex-col gap-6", className)} {...props}>
			...
			<FieldDescription className="text-center">
				...
				<Link href="/login" className="font-bold uppercase tracking-wide cursor-pointer underline underline-offset-2 hover:text-foreground hover:decoration-foreground">
					Log in
				</Link>
			</FieldDescription>
		</div>
