...
function FilePreview({
	...
	return (
		<a
			href={fileUrl}
			download={fileName}
			className="mb-1 flex items-center gap-3 rounded-base border-2 border-border bg-card px-3 py-2 text-sm text-foreground no-underline shadow-brutal-sm transition-all hover:translate-x-[1px] hover:translate-y-[1px] hover:shadow-none"
		>
